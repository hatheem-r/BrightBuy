    ...
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="container mx-auto px-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-brightbuy-primary mb-2">
            Track Your Order
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-green-50 border border-green-200 p-6 rounded-lg text-center flex flex-col justify-center items-center">
              ...
              <h2 className="text-xl font-semibold text-gray-800">
                Your order will take {mockOrder.estimatedDelivery} to reach the
                destination.
              </h2>
              <p className="text-sm text-gray-600 mt-2">
                Contact: {mockOrder.courierContact}
              </p>
              <Link
                href="/"
                className="mt-6 bg-brightbuy-secondary text-white px-6 py-2 rounded-md font-semibold hover:bg-opacity-90"
              >
                Continue Shopping
              </Link>
            </div>
