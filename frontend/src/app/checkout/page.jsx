    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="bg-card border border-card-border p-8 rounded-lg">
          ...
          {!isLoggedIn && (
            <div
              className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-4 mb-6 rounded-md"
              role="alert"
            >
              <p>
                Please{" "}
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  ...
                  className="w-full p-3 bg-background border border-card-border rounded-md"
                />
                <input
                  type="text"
                  name="lastName"
                ...
                <input
                  ...
                  placeholder="Address"
                  onChange={handleInputChange}
                  className="w-full p-3 bg-background border border-card-border rounded-md sm:col-span-2"
                  required
                />
                <input
                  type="text"
        ...
        <div className="bg-card p-8 rounded-lg h-fit border border-card-border">
          ...
          <div className="border-t border-card-border mt-4 pt-4 space-y-2 text-text-secondary">
            ...
            <div className="flex justify-between font-bold text-lg text-text-primary">
              <span>Total</span>
              <span>{formatCurrency(cartSubtotal + 500)}</span>
            </div>
          </div>
          <button
            onClick={handleSubmitOrder}
            className="mt-6 w-full bg-secondary text-white py-3 rounded-md font-semibold hover:bg-opacity-90 transition"
          >
